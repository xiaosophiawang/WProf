...
void ResourceDispatcher::OnReceivedResponse(
  ...
  /*fprintf(stdout, "ResourceDispatcher::OnReceivedResponse %d %d %d %lld\n",
		  request_id,
		  renderer_response_info.load_timing.send_start,
		  renderer_response_info.load_timing.receive_headers_start,
		  request_info->response_start.ToInternalValue()); // Sophia*/
